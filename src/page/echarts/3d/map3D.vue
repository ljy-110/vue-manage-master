<template>
  <div>
    ...
    <img ref="mapSvg" v-show="false" hidden style="width:100%;height:800px" src="../../../assets/image/6.png">
  </div>
</template>
    ...
    initMap2d(chinaJson){
        ...
        geo: [
          {
            ...
            geoIndex: 1,
            zoom: 1,
            center: this.mapCenter,//当前视角的中心点
            // regionHeight: 4, //地图厚度
            // layoutCenter: ["50%", "50%"],
            // layoutSize: "100%",
            zlevel: 4,
            ...
            itemStyle: {
              normal: {
                ...
                // borderColor: '#fff',
                shadowColor: 'rgba(38,108,198, 0.8)',
                shadowBlur: 20,
                shadowOffsetY: 4
              },
              emphasis: {
      ...
      myChart.getZr().on('dblclick', (e)=> {
        ...
        if (name == '广西壮族自治区') {
          ...
          this.mapCenter = [108.35246,22.838225]
          echarts.registerMap("china", this.chinaJson)
